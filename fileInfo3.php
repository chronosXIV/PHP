...
$width = array(35, 10, 10, 22) ;                 		// max width of data in each column
...
/*
function subfolder($subdirectory){
...
function print_file_info() {
    ...
    while ($fldNum < count($info)) {
        printf("%-{$width[$fldNum]}.{$width[$fldNum]}s", basename($info[$fldNum])) ;
        $fldNum++ ;
    }
    print "\n" ;
}
