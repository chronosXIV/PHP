...
// arrays.
$headers = array("File Name", "Size", "Type", "Link") ;	// column headers
$width = array(25, 10, 10, 30) ;                 		// max width of data in each column
...
$dups = array();
foreach(array_count_values($inolist) as $val => $count)
    if($count > 1) {
      $dups[] = $val;
  }
